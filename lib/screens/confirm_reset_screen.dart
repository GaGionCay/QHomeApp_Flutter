...
class ConfirmResetScreen extends StatefulWidget {
  ...
  const ConfirmResetScreen({super.key, required this.email, required this.otp, required this.authService});
...
class _ConfirmResetScreenState extends State<ConfirmResetScreen> {
  ...
  void _resetPassword() async {
    ...
    final success = await widget.authService.confirmReset(widget.email, widget.otp, _passwordController.text);
