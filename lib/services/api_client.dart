...
class ApiClient {
  ...
  Future<http.Response> get(String path) async => _sendRequest('GET', path);
  Future<http.Response> post(String path, {Map<String, dynamic>? body}) async => _sendRequest('POST', path, body: body);
