...
//     try {
//       print(
//           '📸 [ChatScreen] Bắt đầu chọn ảnh từ ${source == ImageSource.gallery ? "gallery" : "camera"}');
...
//         print(
//             '✅ [ChatScreen] Đã chụp ảnh: ${image.path}, size: ${await image.length()} bytes');
...
//     try {
//       print(
//           '🎥 [ChatScreen] Bắt đầu chọn video từ ${source == ImageSource.gallery ? "gallery" : "camera"}');
...
//       print(
//           '📹 [ChatScreen] Video gốc duration: ${originalDuration}ms (${(originalDuration / 1000).toStringAsFixed(2)}s)');
...
//           print(
//               '✅ [ChatScreen] Video đã được compress: ${compressedVideo.path}');
...
//           print(
//               '📹 [ChatScreen] Video sau compress duration: ${compressedDuration}ms (${(compressedDuration / 1000).toStringAsFixed(2)}s)');
...
//                   ? fileSizeValue
//                   : int.tryParse(fileSizeValue.toString()) ??
...
//             );
//             print(
//                 '✅ [ChatScreen] Video đã được lưu vào public storage: $savedPath');
//           } catch (e) {
...
//           );
//           print(
//               '✅ [ChatScreen] Audio file saved to public storage: $savedPublicPath');
//         } catch (e) {
...
//           print(
//               '✅ [ChatScreen] Upload audio thành công: ${result['audioUrl']}');
...
//           final savedPublicPath =
//               await PublicFileStorageService.getExistingFilePath(
//             path.split('/').last,
//             'audio',
...
//           } else {
//             print(
//                 '✅ [ChatScreen] Giữ lại file vì đã lưu vào public storage: $path');
//           }
//         }
//       }
//     } catch (e, stackTrace) {
...
//           final fileType =
//               PublicFileStorageService.getFileType(mimeType, fileName);
//           final fileExtension =
...
//       BuildContext context, ChatMessageViewModel viewModel) async {
//     final messenger = ScaffoldMessenger.of(context);
...
//   Future<void> _showMessageOptionsBottomSheet(BuildContext context,
//       ChatMessage message, ChatMessageViewModel viewModel) async {
//     // Only allow edit/delete for messages sent by current user
//     final isMyMessage = viewModel.currentResidentId != null &&
//         message.senderId == viewModel.currentResidentId;
...
//       ChatMessageViewModel viewModel) async {
...
//                     print(
//                         '🖼️ [MessageBubble] Hiển thị ảnh, messageId: ${message.id}');
//                     print(
//                         '🖼️ [MessageBubble] Original imageUrl: ${message.imageUrl}');
...
//                         onTap: () {
//                           print(
//                               '👆 [MessageBubble] Tap vào ảnh, mở full screen');
//                           if (onImageTap != null) {
//                             onImageTap!(message);
//                           }
//                         },
//                         onLongPress: () {
//                           print(
//                               '👆 [MessageBubble] Long press vào ảnh, hiển thị menu');
...
//                             print(
//                                 '❌ [MessageBubble] Lỗi load ảnh: $url, error: $error');
//                             return Container(
//                               height: 200,
...
//       -1; // Track last progress to avoid too frequent updates
...
//       final cachedPath =
//           await _fileCacheService.getCachedFilePath(widget.fileUrl);
//       if (mounted) {
//         setState(() {
...
//       print(
//           '📂 [FileMessageWidget] Open result: ${result.type}, message: ${result.message}');
...
//         debugPrint(
//             '⚠️ [ChatVideo] Skipping ImageKit video (out of storage): $videoUrl');
//         if (mounted) {
//           setState(() {
